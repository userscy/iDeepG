...
#from main.modeling_esm import RotaryEmbedding
...
class MultiHeadAttention(nn.Module):
    def __init__(self, 
        ...
        self.query = nn.Linear(hidden_size, omics_of_interest_size) # 2560, 2560

        self.key = nn.Linear(other_omic_size, omics_of_interest_size) # 1280, 2560

        self.value = nn.Linear(other_omic_size, omics_of_interest_size) # 1280, 2560

        self.dense = nn.Linear(omics_of_interest_size, hidden_size) # 2560, 2560
